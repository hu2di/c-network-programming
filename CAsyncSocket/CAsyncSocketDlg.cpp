// CAsyncSocketDlg.cpp : implementation file
//
...
CCAsyncSocketDlg::CCAsyncSocketDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCAsyncSocketDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CCAsyncSocketDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_KETNOI, &CCAsyncSocketDlg::OnBnClickedKetnoi)
END_MESSAGE_MAP()


// CCAsyncSocketDlg message handlers
...
void CCAsyncSocketDlg::OnBnClickedKetnoi()
{
	// TODO: Add your control notification handler code here
	socket.pWnd = this;
	socket.Create();
	socket.Connect(L"127.0.0.1",8888);
}
